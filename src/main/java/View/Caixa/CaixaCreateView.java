...
public class CaixaCreateView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btCadastrarCaixa.setActionCommand("Cadastrar Caixa");
        btCadastrarCaixa.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        btCadastrarCaixa.setLabel("Cadastrar Caixa");
        btCadastrarCaixa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btCadastrarCaixa(evt);
            }
        });
    ...
    private void btCadastrarCaixa(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarCaixa
        String cor = tfCor.getText();
        String etiqueta = tfEtiqueta.getText();

        Caixa caixa = new Caixa(cor, etiqueta);
        caixaDAO.adicionarCaixa(caixa);
        JOptionPane.showMessageDialog(null, "Caixa cadastrada com sucesso!");

    }//GEN-LAST:event_btCadastrarCaixa
